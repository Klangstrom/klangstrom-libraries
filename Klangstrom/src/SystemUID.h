...
#define KLST_NUM_OF_U_ID (1 + 10 + 5 + 10 + 10 + 10) // NO BOARD + 10 TINY + 5 CORE + 10 SHEEP + 10 PANDA + 10 CATERPILLAR
...
const uint32_t    KLST_U_ID[KLST_NUM_OF_U_ID][3] = {
    ...
    {0x0014001F, 0xFFFFFFFF, 0x000002F6}, // KLST_CATERPILLAR_36
    {0x0015002C, 0xFFFFFFFF, 0x00000301}, // KLST_CATERPILLAR_37
    {0x0015002B, 0xFFFFFFFF, 0x000002FA}, // KLST_CATERPILLAR_38
    {0x00130035, 0xFFFFFFFF, 0x00000300}, // KLST_CATERPILLAR_39
    {0x0013002F, 0xFFFFFFFF, 0x000002FB}, // KLST_CATERPILLAR_40
    {0x00130019, 0xFFFFFFFF, 0x000002FB}, // KLST_CATERPILLAR_41
    {0x00130018, 0xFFFFFFFF, 0x00000301}, // KLST_CATERPILLAR_42
    {0x00140021, 0xFFFFFFFF, 0x000002F7}, // KLST_CATERPILLAR_43
    {0x00130016, 0xFFFFFFFF, 0x000002FA}, // KLST_CATERPILLAR_44
    {0x00140020, 0xFFFFFFFF, 0x00000307}, // KLST_CATERPILLAR_45
};
