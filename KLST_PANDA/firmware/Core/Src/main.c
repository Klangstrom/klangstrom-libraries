...
//#define CALL_MX
  ...
  HAL_GPIO_WritePin(_DISPLAY_BACKLIGHT_PWM_GPIO_Port, _DISPLAY_BACKLIGHT_PWM_Pin, GPIO_PIN_SET);
  /* USER CODE END 2 */
  ...
  while (1)
  {
	...
	HAL_GPIO_TogglePin(_DISPLAY_BACKLIGHT_PWM_GPIO_Port, _DISPLAY_BACKLIGHT_PWM_Pin);
	printf("*\r\n");
	HAL_Delay(500);
  }
  /* USER CODE END 3 */
