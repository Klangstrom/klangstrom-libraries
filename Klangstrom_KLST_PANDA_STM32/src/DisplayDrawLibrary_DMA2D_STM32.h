...
/* implementation taken and sightly modified from auto generated TouchGFX code from `STM32DMA.hpp/cpp` */
...
struct BlitOp {
    ...
    const uint32_t* pSrc;      ///< Pointer to the source (pixels or indexes)
