...
void display_clear_dma2d(const uint32_t color) {
    display_rect_fill_dma2d(0, 0, KLST_DISPLAY_WIDTH, KLST_DISPLAY_HEIGHT, color);
}
...
void display_rect_fill_dma2d(const uint16_t x,
                             const uint16_t y,
                             const uint16_t width,
                             const uint16_t height,
                             const uint32_t color) {
...
void display_image_dma2d(uint32_t*      data,
                         const uint16_t x,
                         const uint16_t y,
                         const uint16_t width,
                         const uint16_t height) {
