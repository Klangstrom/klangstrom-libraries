...
#
# e.g `link-variant-files.sh $KLST_ORG/klangstrom-hardware/KLST_PANDA/variant $HOME/Library/Arduino15/packages/STMicroelectronics/hardware/stm32/2.7.1/variants/STM32H7xx/H723Z\(E-G\)T_H730ZBT_H733ZGT`
#
